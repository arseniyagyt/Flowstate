...
import 'package:flowstate/pages/email_verification_page.dart';
import 'package:flowstate/services/firebase_stream.dart';
import 'package:flowstate/pages/home_page.dart'; // Для ExercisesScreen, ReadyWorkoutsScreen, CreateWorkoutScreen
import 'package:flowstate/pages/ready_workouts_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/verify_email': (context) => VerifyEmailScreen(email: FirebaseAuth.instance.currentUser?.email),
      },
      initialRoute: '/',
    );
  }
