...
import 'package:flowstate/pages/home_page.dart'; // Импортируем для доступа к диалогу
            ...
            children: [
              ...
              IconButton(
                ...
                style: IconButton.styleFrom(
                  side: const BorderSide(color: Color(0xFF92A880), width: 2),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                ),
              ),
            ],
                ...
                Stack(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text( 'Тренировка: Растяжка', textAlign: TextAlign.center, style: TextStyle( fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black, ), ),
                    ),
                    Positioned(
                      left: 0,
                      child: IconButton(
